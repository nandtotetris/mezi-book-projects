...
const component_decorator_1 = require("@nestjs/common/decorators/core/component.decorator");
const files_constants_1 = require("@nestjs/common/files/files.constants");
const multer_utils_1 = require("@nestjs/common/files/multer/multer.utils");
function AnyFileInterceptor(fieldName, localOptions) {
...
exports.AnyFileInterceptor = AnyFileInterceptor;
